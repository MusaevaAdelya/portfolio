...
function Projects() {
    ...
    return (
        <section id="projects" className="bg-accent relative rounded-2xl lg:rounded-[50px] overflow-hidden border-dashed border-2 border-dark-500 pt-5 lg:pt-10 px-5 lg:px-30 pb-8 lg:pb-15 mb-10">
            <PlacedFlower top="4%" left="37%" size={50}>
                <FlowerLightRedOutlinedBeige style={{ width: "100%", height: "100%" }} className="hidden lg:block"/>
            </PlacedFlower>
            ...
            <div className="z-10 relative px-0 xl:px-20 mt-7 pb-10">
                <h2 className="uppercase text-light-350 font-bold text-center mb-5 lg:mb-15 text-3xl lg:text-4xl" data-aos="fade-up">my projects</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 xl:gap-7">
                    ...
                    <div data-aos="fade-up" data-aos-delay="500" className="min-h-[400px] lg:min-h-[500px] relative flex flex-col text-white bg-accent py-13 px-8 rounded-4xl text-xl gap-3 border-3 border-secondary justify-center items-center hover:scale-105 transition-transform duration-300">
                        <p className="text-secondary font-bold text-2xl lg:text-4xl text-center leading-normal lg:leading-11">HERE CAN BE<br />YOUR<br />APPLICATION</p>
                        <button 
